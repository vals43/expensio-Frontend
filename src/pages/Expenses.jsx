...
import {
  useJsonDailySummary,
  useJsonExpensesBySource,
} from "./../api/summary/useJsonSummary";
...
const Expenses = () => {
  ...
  const categorySummary = Array.isArray(summary?.data) ? summary.data : [];
          ...
          <Card className="md:col-span-1 p-6 bg-white dark:bg-dark-card">
            ...
            <div className="space-y-4">
              {categorySummary.map((item, index) => {
                const percentage =
                  Math.round((item.totalAmount / totalExpenses) * 100) || 0;
                return (
